...
class ReportController extends Controller
{
            ...
            case 'po':
                ...
                return [
                    ...
                    'columns' => [
                        ...
                        ['field' => 'subtotal', 'label' => 'Total', 'format' => 'rupiah', 'align' => 'end'],
            ...
            case 'payment':
                ...
                return [
                    ...
                    'columns' => [
                        ...
                        ['field' => 'amount', 'label' => 'Nominal', 'format' => 'rupiah', 'align' => 'end'],
                    ],
                    'rows' => $rows,
                    'filterForm' => ['date' => true, 'project' => true, 'status' => $model->statusLabels, 'keyword' => true],
                    'filters' => compact('dateFrom', 'dateTo', 'projectId', 'status', 'keyword'),
            ...
            case 'invoice':
                ...
                return [
                    ...
                    'columns' => [
                        ...
                        ['field' => 'dp_amount', 'label' => 'Tagihan DP', 'format' => 'rupiah', 'align' => 'end'],
                        ['field' => 'ppn_amount', 'label' => 'PPN', 'format' => 'rupiah', 'align' => 'end'],
                        ['field' => 'total_amount', 'label' => 'Total', 'format' => 'rupiah', 'align' => 'end'],
                    ],
                    'rows' => $rows,
    ...
    private function poDetailColumns(): array
    {
        return [
            ...
            ['field' => 'subtotal', 'label' => 'Total', 'format' => 'rupiah', 'align' => 'end', 'width' => 16],
    ...
    private function poRecapColumns(): array
    {
        return [
            ['field' => 'po_date', 'label' => 'Tanggal', 'format' => 'date', 'width' => 16],
            ['field' => 'supplier_name', 'label' => 'Supplier', 'width' => 22],
            ['field' => 'nilai_po', 'label' => 'Nilai PO', 'format' => 'rupiah', 'align' => 'end', 'width' => 18],
            ['field' => 'total_dibayar', 'label' => 'Total dibayar', 'format' => 'rupiah', 'align' => 'end', 'width' => 18],
            ['field' => 'sisa_belum_dibayar', 'label' => 'Sisa belum dibayar', 'format' => 'rupiah', 'align' => 'end', 'width' => 20],
