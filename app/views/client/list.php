...
function clientSortLink(string $col, string $label, string $sort, string $dir): string
{
    ...
    $url = BASE_URL . '/index.php?module=client&sort=' . urlencode($col) . '&dir=' . $nextDir;
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?= BASE_URL ?>/index.php?module=client&action=create" class="btn btn-primary">
    ...
    <div class="card-body">
        <form method="GET" action="<?= BASE_URL ?>/index.php" class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a href="<?= BASE_URL ?>/index.php?module=client" class="btn btn-sm btn-outline-secondary">
                    ...
                    <?php if (empty($clients)): ?>
                        <tr><td colspan="7" class="p-0">
                            <div class="empty-state">
                                ...
                                <a href="<?= BASE_URL ?>/index.php?module=client&action=create" class="btn btn-sm btn-primary">
                                    <i class="bi bi-plus-circle"></i> Tambah Client
                                </a>
                            </div>
                        </td></tr>
                            ...
                            <td class="text-center no-print">
                                <div class="dropdown row-actions">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="<?= BASE_URL ?>/index.php?module=client&action=edit&id=<?= (int) $c['id'] ?>">
