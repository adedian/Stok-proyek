...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= BASE_URL ?>/index.php?module=payment_method" class="btn btn-outline-secondary">
...
<form method="POST" action="<?= BASE_URL ?>/index.php?module=payment_method&action=<?= $actionUrl ?>">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?= BASE_URL ?>/index.php?module=payment_method" class="btn btn-light border">Batal</a>
    </div>
</form>
