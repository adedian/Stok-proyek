    ...
    <div class="card-body">
        <form method="GET" action="<?= BASE_URL ?>/index.php" class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2 no-print">
                <a href="<?= BASE_URL ?>/index.php?module=project&action=exportCsv&<?= e($baseQuery) ?>" class="btn btn-sm btn-outline-success w-100">
                                        ...
                                        <li>
                                            <form method="POST" action="<?= BASE_URL ?>/index.php?module=project&action=toggleStatus">
                                                ...
                                                <button type="submit" class="dropdown-item">
                                                    <i class="bi bi-<?= $p['status'] === 'closed' ? 'arrow-counterclockwise' : 'archive' ?>"></i>
                                                    <?= $p['status'] === 'closed' ? 'Aktifkan' : 'Tutup Project' ?>
                                                </button>
                                            </form>
                                        </li>
                                        <li>
