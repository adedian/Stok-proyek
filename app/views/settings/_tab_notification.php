...
$notifItems = [
    ...
    'notify_validasi_barang'    => ['label' => 'Validasi Barang', 'desc' => 'Peringatan (lonceng + dashboard + push) saat ada penerimaan barang sesuai pesanan yang tetap menunggu validasi -- hanya tampil ke pengguna yang berwenang memvalidasi.'],
