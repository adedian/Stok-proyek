...
function supplierSortLink(string $col, string $label, string $sort, string $dir): string
{
    ...
    $url = route('supplier', 'index', ['sort' => $col, 'dir' => $nextDir]);
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <form method="GET" action="<?= BASE_URL ?>/supplier" class="row g-2 align-items-end">
            <div class="col-md-5">
                    ...
                    <?php if (empty($suppliers)): ?>
                        <tr><td colspan="7" class="p-0">
                            <div class="empty-state">
                                ...
                                <a href="<?= BASE_URL ?>/supplier/create" class="btn btn-sm btn-primary">
                                    <i class="bi bi-plus-circle"></i> Tambah Supplier
                                </a>
                            </div>
                        </td></tr>
